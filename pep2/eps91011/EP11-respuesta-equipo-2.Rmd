...
Como se puede observar, ningúnpredictor tiene desviación estándar 0
...
crPlots(modelo_lm, ask = FALSE)
```
Podemos observar que todas las variables tienen ua relación aproximadamente lineal y pasan la prueba de curvatura a excepción de Chest.diameter, pero puede deberse a unos valores atípicos no eliminados
