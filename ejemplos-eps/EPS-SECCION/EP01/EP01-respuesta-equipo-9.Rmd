...
resumen %>% kbl(caption = "Tabla 2. Estadisticos") %>% kable_classic_2(full_width = T, html_font = "Cambria", bootstrap_options = "striped")
...
- Haciendo un analisis descriptivo, se puede decir que si existe una diferencia de ingreso según el estado civil, puesto que como se puede observar en el gráfico con los diagramas de caja y en la tabla, varia la media y la mediana de los de ingresos de las mujeres según el estado civil, ademas de que tambien varía el intervalo en el que se concentran la mayoría de los ingresos.
