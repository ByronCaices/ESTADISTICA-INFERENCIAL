...
Finalmente obtenemos que el p-value = 0.6136, un valor mayor a 0.05, por ende se falla al rechazar la hipótesis nula. Es decir, no hay evidencia suficiente para afirmar que las distribuciones de las preferencias de transporte entre los dos grupos demográficos son distintas.
...
Finalmente obtenemos que el p-value = 0.7728, un valor mayor a 0.05, por ende se falla al rechazar la hipótesis nula. Es decir, no hay evidencia suficiente para afirmar que el nuevo protocolo de limpieza haya tenido un efecto significativo en la calidad de limpieza de las habitaciones del hotel.
